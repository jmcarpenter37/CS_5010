...
# Total visits greater than 1000 and less than 10000
print("START NEW QUERIES")
print("\n****************", end='')
print('\n**** Visits less than 1000 and Greater than 100:')
print(df[(df['Total Visits (000)'] > 100) &  (df['Total Visits (000)'] < 100000)] )

# print df
print("QUERY 2")
print("\n****************", end='')
print("\n****: Total Number of Minutes")
print(df['Total Minutes (MM)'])

# print df
print(df.keys())
print("QUERY 3")
print("\n****************", end='')
print("\n****: Average Visits per Visitor first 100")
print(df['Average Visits per Visitor'].head(100))
