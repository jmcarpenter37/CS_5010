...
# -*- coding: utf-8 -*-
"""
Writing Unit Tests - Module 5 Assigment
...
import os
os.getcwd()
os.chdir("/Users/omkar.kharkar/Personal")
import unittest

from Module_5_Assignment import BookLover 
...
class BookLoverTest(unittest.TestCase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.bob1 = BookLover("Bob", "bob@gmail.com", "Fiction")
        self.bob2 = BookLover("Bob", "bob@gmail.com", "Fiction", 2)
        self.mary = BookLover("Mary", "Mary@gmail.com", "Horror", 2, [("The Catcher in the Rye", 3.5), ("The Grapes of Wrath", 4)])
        self.katy = BookLover("Katy", "Katy@gmail.com", "Horror", 2, [("IT", 3), ("The Mist", 2.85)])
